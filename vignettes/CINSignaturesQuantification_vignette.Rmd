...
author: "Philip Smith <cre, auth>, Ruben Drews <cre, auth>, Cancer Research UK <cph, fnd>"
...
```{r test_data}
test_data = readRDS("data/TCGA_478_Samples_SNP6_GOLD.rds")
...
```{r sxc_plotting}
plotSampleByComponent(object = myData)
```
