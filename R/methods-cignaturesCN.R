setMethod("show", signature=c(object="cignaturesCN"),
...
#' @param drop not used
#'
setMethod("[", signature=c("cignaturesCN", "numeric", "missing", "ANY"),
...
#' @param drop not used
#'
setMethod("[", signature=c("cignaturesCN", "character", "missing", "ANY"),
          definition=function(x, i, j, ..., drop=TRUE){
