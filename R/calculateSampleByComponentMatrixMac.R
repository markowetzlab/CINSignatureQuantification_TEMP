calculateSampleByComponentMatrixMac <- function(CN_features, all_components=NULL, cores = 1, rowIter = 1000, subcores = 2, method=method)
{
...
## Create input matrix
calculateSampleByComponentMatrixMacNEW = function(brECNF, UNINFPRIOR = TRUE) {
